...
/**
 * Precompiled org.jeecgframework.boot.java-conventions script plugin.
 **/
public class OrgJeecgframeworkBootJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OrgJeecgframeworkBootJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgJeecgframeworkBootJavaConventions").asSubclass(BasicScript.class);
